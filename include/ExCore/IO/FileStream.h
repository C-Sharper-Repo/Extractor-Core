...
public:
    ...
    size_t read(void* buffer, size_t elementSize, size_t count) const override;
    size_t write(const void* buffer, const size_t elementSize, const size_t count) const override;
